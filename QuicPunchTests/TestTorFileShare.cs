    ...
    public static class TestTorFileShare
    {
        public static async Task RunAsync(string[]? args = null)
        {
            ...
            try
            {
                ...
                if (nodeA.CertManager.CertPublicHash.SequenceEqual(nodeA.TorCertManager.CertPublicHash))
                {
                    throw new InvalidOperationException("Node A is reusing WAN certificate for Tor! Anonymity compromised.");
                }
                ...
                if (nodeB.CertManager.CertPublicHash.SequenceEqual(nodeB.TorCertManager.CertPublicHash))
                {
                    throw new InvalidOperationException("Node B is reusing WAN certificate for Tor! Anonymity compromised.");
                }
